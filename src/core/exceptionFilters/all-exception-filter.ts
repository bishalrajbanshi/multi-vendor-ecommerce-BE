...
export class AllExceptionsFilter implements ExceptionFilter {
  ...
  private getErrorDetails(exception: unknown): {
    ...
    if (exception instanceof TypeError) {
      return { message: exception.message, error: "Type Error", errorType: "TypeError" };
    }
    if (exception instanceof ReferenceError) {
      return { message: exception.message, error: "Reference Error", errorType: "ReferenceError" };
    }
    if (exception instanceof RangeError) {
      return { message: exception.message, error: "Range Error", errorType: "RangeError" };
    }
    if (exception instanceof SyntaxError) {
      return { message: exception.message, error: "Syntax Error", errorType: "SyntaxError" };
    }
    ...
    if (exception instanceof HttpException) {
      ...
      return { message: excResp, error: "Http Exception", errorType: "HttpException" };
    }

    // Generic Error
    if (exception instanceof Error) {
      return { message: exception.message, error: "Internal Server Error", errorType: exception.constructor.name };
    }

    // Unknown error
    return { message: "Internal server error", error: "Internal Server Error", errorType: "Unknown" };
  }
}